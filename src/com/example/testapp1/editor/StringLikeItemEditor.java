...
class StringLikeItemEditor implements OnClickListener {
	...
	private static abstract class Serializer {
		Class typeClass;
		String typeName;
		Serializer(Class typeClass, String typeName) {this.typeClass = typeClass; this.typeName = typeName; }
		String makeString(Object o) {return o.toString(); }
	...
	public void onClick(DialogInterface dialog, int which) {
		if (which == AlertDialog.BUTTON_POSITIVE) {
			...
			mChangeObserver.afterEdit(newName != mOriginalName);
		}
	}
}
